            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/php_tutorial/laracasts/" aria-current="page"
                            class="<?= urlIs('/php_tutorial/laracasts/') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> text-gray-300 hover:bg-gray-700 px-3 py-2 rounded-md px-3 py-2 text-sm font-medium">Home</a>
                        <a href="/php_tutorial/laracasts/about.php"
                            class="<?= urlIs('/php_tutorial/laracasts/about.php') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                        <a href="/php_tutorial/laracasts/contact.php"
                            class="<?= urlIs('/php_tutorial/laracasts/contact.php') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
