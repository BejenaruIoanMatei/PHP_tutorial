                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="./" aria-current="page"
                            class="text-gray-300 hover:bg-gray-700 px-3 py-2 rounded-md px-3 py-2 text-sm font-medium">Home</a>
                        <a href="./about.php"
                            class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                        <a href="./contact.php"
